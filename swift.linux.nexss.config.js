...
languageConfig.compilers = {
  apt: {
    // Ubuntu
    install: `${sudo}apt install clang libcurl3 libpython2.7 libpython2.7-dev
  ...
  ${sudo}apt remove libc6-dbg # This needs to be here due to error: ld-2.27.so 0x7fffffff0005c587: adding range [0x1469a-0x1470a) which has a base that is less than the function's low PC 0x14e10
